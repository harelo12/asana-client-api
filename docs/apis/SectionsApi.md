# AsanaApiClient.Api.SectionsApi
...
# **AddTaskForSection**
> ApproveAccessRequest200Response AddTaskForSection (string sectionGid, bool optPretty = null, AddTaskForSectionRequest addTaskForSectionRequest = null)
...
| **addTaskForSectionRequest** | [**AddTaskForSectionRequest**](AddTaskForSectionRequest.md) | The task and optionally the insert location. | [optional]  |
...
> GetSection200Response CreateSectionForProject (string projectGid, bool optPretty = null, List<string> optFields = null, UpdateSectionRequest updateSectionRequest = null)
...
| **updateSectionRequest** | [**UpdateSectionRequest**](UpdateSectionRequest.md) | The section to create. | [optional]  |
...
# **DeleteSection**
> ApproveAccessRequest200Response DeleteSection (string sectionGid, bool optPretty = null)
...
> GetSectionsForProject200Response GetSectionsForProject (string projectGid, bool optPretty = null, int limit = null, string offset = null, List<string> optFields = null)
...
> ApproveAccessRequest200Response InsertSectionForProject (string projectGid, bool optPretty = null, InsertSectionForProjectRequest insertSectionForProjectRequest = null)
...
| **projectGid** | **string** | Globally unique identifier for the project. |  |
| **optPretty** | **bool** | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. | [optional]  |
| **insertSectionForProjectRequest** | [**InsertSectionForProjectRequest**](InsertSectionForProjectRequest.md) | The section&#39;s move action. | [optional]  |
...
# **UpdateSection**
> GetSection200Response UpdateSection (string sectionGid, bool optPretty = null, List<string> optFields = null, UpdateSectionRequest updateSectionRequest = null)
