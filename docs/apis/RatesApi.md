...
<a id="createrate"></a>
# **CreateRate**
> CreateRate201Response CreateRate (CreateRateRequest createRateRequest, bool optPretty = null, List<string> optFields = null)
...
|------|------|-------------|-------|
| **createRateRequest** | [**CreateRateRequest**](CreateRateRequest.md) | The rate to create. |  |
...
<a id="deleterate"></a>
# **DeleteRate**
> ApproveAccessRequest200Response DeleteRate (string rateGid, bool optPretty = null)
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **rateGid** | **string** | Globally unique identifier for the rate. |  |
| **optPretty** | **bool** | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. | [optional]  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Successfully deleted the rate. |  -  |
| **400** | This usually occurs because of a missing or malformed parameter. Check the documentation and the syntax of your request and try again. |  -  |
| **401** | A valid authentication token was not provided with the request, so the API could not associate a user with the request. |  -  |
| **402** | The request was valid, but the queried object or object mutation specified in the request is above your current premium level. |  -  |
| **403** | The authentication and request syntax was valid but the server is refusing to complete the request. This can happen if you try to read or write to objects or properties that the user does not have access to. |  -  |
...
<a id="getrate"></a>
# **GetRate**
> CreateRate201Response GetRate (string rateGid, bool optPretty = null, List<string> optFields = null)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Successfully retrieved the record for a single rate. |  -  |
| **400** | This usually occurs because of a missing or malformed parameter. Check the documentation and the syntax of your request and try again. |  -  |
| **401** | A valid authentication token was not provided with the request, so the API could not associate a user with the request. |  -  |
| **402** | The request was valid, but the queried object or object mutation specified in the request is above your current premium level. |  -  |
| **403** | The authentication and request syntax was valid but the server is refusing to complete the request. This can happen if you try to read or write to objects or properties that the user does not have access to. |  -  |
...
<a id="getrates"></a>
# **GetRates**
> GetRates200Response GetRates (bool optPretty = null, string parent = null, string resource = null, int limit = null, string offset = null, List<string> optFields = null)
...
<a id="updaterate"></a>
# **UpdateRate**
> CreateRate201Response UpdateRate (string rateGid, UpdateRateRequest updateRateRequest, bool optPretty = null, List<string> optFields = null)
...
|------|------|-------------|-------|
| **rateGid** | **string** | Globally unique identifier for the rate. |  |
| **updateRateRequest** | [**UpdateRateRequest**](UpdateRateRequest.md) | The updated fields for the rate. |  |
| **optPretty** | **bool** | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. | [optional]  |
| **optFields** | [**List&lt;string&gt;**](string.md) | This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. | [optional]  |
