# AsanaApiClient.Api.TimePeriodsApi
...
# **GetTimePeriods**
> GetTimePeriods200Response GetTimePeriods (string workspace, bool optPretty = null, int limit = null, string offset = null, DateOnly startOn = null, DateOnly endOn = null, List<string> optFields = null)
...
| **startOn** | **DateOnly** | ISO 8601 date string | [optional]  |
| **endOn** | **DateOnly** | ISO 8601 date string | [optional]  |
| **optFields** | [**List&lt;string&gt;**](string.md) | This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. | [optional]  |
