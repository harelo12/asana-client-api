...
> CreateTag201Response CreateTagForWorkspace (string workspaceGid, CreateTagForWorkspaceRequest createTagForWorkspaceRequest, bool optPretty = null, List<string> optFields = null)
...
| **createTagForWorkspaceRequest** | [**CreateTagForWorkspaceRequest**](CreateTagForWorkspaceRequest.md) | The tag to create. |  |
| **optPretty** | **bool** | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. | [optional]  |
| **optFields** | [**List&lt;string&gt;**](string.md) | This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. | [optional]  |
...
<a id="deletetag"></a>
# **DeleteTag**
> ApproveAccessRequest200Response DeleteTag (string tagGid, bool optPretty = null)
...
<a id="gettag"></a>
# **GetTag**
> CreateTag201Response GetTag (string tagGid, bool optPretty = null, List<string> optFields = null)
...
<a id="gettags"></a>
# **GetTags**
> GetTags200Response GetTags (bool optPretty = null, int limit = null, string offset = null, string workspace = null, List<string> optFields = null)
...
# **GetTagsForTask**
> GetTags200Response GetTagsForTask (string taskGid, bool optPretty = null, int limit = null, string offset = null, List<string> optFields = null)
...
# **GetTagsForWorkspace**
> GetTags200Response GetTagsForWorkspace (string workspaceGid, bool optPretty = null, int limit = null, string offset = null, List<string> optFields = null)
...
<a id="updatetag"></a>
# **UpdateTag**
> CreateTag201Response UpdateTag (string tagGid, UpdateTagRequest updateTagRequest, bool optPretty = null, List<string> optFields = null)
...
|------|------|-------------|-------|
| **tagGid** | **string** | Globally unique identifier for the tag. |  |
| **updateTagRequest** | [**UpdateTagRequest**](UpdateTagRequest.md) | The tag to update. |  |
| **optPretty** | **bool** | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. | [optional]  |
| **optFields** | [**List&lt;string&gt;**](string.md) | This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. | [optional]  |
