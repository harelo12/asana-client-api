# AsanaApiClient.Model.ProjectUpdateRequest
...
**Team** | **string** | *Deprecated:* Updating the team a project is shared with is deprecated. Use &#x60;POST /memberships&#x60; with &#x60;{ parent: project, member: team }&#x60; instead to manage team sharing. | [optional] 
