...
namespace AsanaApiClient.Test.Model
{
    ...
    public class CustomFieldRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" CustomFieldRequest
            //Assert.IsType<CustomFieldRequest>(instance);
        }
