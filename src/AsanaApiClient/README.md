...
inputSpec: asana_oas.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{BD72B52F-E214-4CCD-AA47-00B5A855A06F}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAccessRequestsApi>();
            IApproveAccessRequestApiResponse apiResponse = await api.ApproveAccessRequestAsync("todo");
            ApproveAccessRequest200Response? model = apiResponse.Ok();
        }
...
- appName: Asana
- appVersion: 1.0
- appDescription: This is the interface for interacting with the [Asana Platform](https://developers.asana.com). Our API reference is generated from our [OpenAPI spec] (https://raw.githubusercontent.com/Asana/openapi/master/defs/asana_oas.yaml).
