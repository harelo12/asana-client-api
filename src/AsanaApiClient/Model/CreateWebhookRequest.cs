...
namespace AsanaApiClient.Model
{
    ...
    public partial class CreateWebhookRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateWebhookRequest(Option<WebhookRequest?> data = default)
        {
            DataOption = data;
            OnCreated();
        }
        ...
        public Option<WebhookRequest?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public WebhookRequest? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
    ...
    public class CreateWebhookRequestJsonConverter : JsonConverter<CreateWebhookRequest>
    {
        ...
        public override CreateWebhookRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookRequest?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<WebhookRequest?>(JsonSerializer.Deserialize<WebhookRequest>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
