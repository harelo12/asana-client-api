...
namespace AsanaApiClient.Model
{
    ...
    public partial class CreateRoleRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateRoleRequest(Option<RbacRoleRequest?> data = default)
        {
            DataOption = data;
            OnCreated();
        }
        ...
        public Option<RbacRoleRequest?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public RbacRoleRequest? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
    ...
    public class CreateRoleRequestJsonConverter : JsonConverter<CreateRoleRequest>
    {
        ...
        public override CreateRoleRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<RbacRoleRequest?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<RbacRoleRequest?>(JsonSerializer.Deserialize<RbacRoleRequest>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CreateRoleRequest.");
        ...
        {
            if (createRoleRequest.DataOption.IsSet && createRoleRequest.Data == null)
                throw new ArgumentNullException(nameof(createRoleRequest.Data), "Property is required for class CreateRoleRequest.");

            if (createRoleRequest.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, createRoleRequest.Data, jsonSerializerOptions);
            }
        }
    }
}
