...
namespace AsanaApiClient.Model
{
    ...
    public partial class UpdateWebhookRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateWebhookRequest(Option<WebhookUpdateRequest?> data = default)
        {
            DataOption = data;
            OnCreated();
        }
        ...
        public Option<WebhookUpdateRequest?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public WebhookUpdateRequest? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
    ...
    public class UpdateWebhookRequestJsonConverter : JsonConverter<UpdateWebhookRequest>
    {
        ...
        public override UpdateWebhookRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookUpdateRequest?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<WebhookUpdateRequest?>(JsonSerializer.Deserialize<WebhookUpdateRequest>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class UpdateWebhookRequest.");

            return new UpdateWebhookRequest(data);
        }
        ...
        {
            if (updateWebhookRequest.DataOption.IsSet && updateWebhookRequest.Data == null)
                throw new ArgumentNullException(nameof(updateWebhookRequest.Data), "Property is required for class UpdateWebhookRequest.");

            if (updateWebhookRequest.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, updateWebhookRequest.Data, jsonSerializerOptions);
            }
        }
    }
}
