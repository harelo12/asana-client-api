...
namespace AsanaApiClient.Model
{
    ...
    public partial class CreateTaskRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateTaskRequest(Option<TaskRequest?> data = default)
        {
            DataOption = data;
            OnCreated();
        }
        ...
        public Option<TaskRequest?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public TaskRequest? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
    ...
    public class CreateTaskRequestJsonConverter : JsonConverter<CreateTaskRequest>
    {
        ...
        public override CreateTaskRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TaskRequest?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<TaskRequest?>(JsonSerializer.Deserialize<TaskRequest>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CreateTaskRequest.");
        ...
        {
            if (createTaskRequest.DataOption.IsSet && createTaskRequest.Data == null)
                throw new ArgumentNullException(nameof(createTaskRequest.Data), "Property is required for class CreateTaskRequest.");

            if (createTaskRequest.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, createTaskRequest.Data, jsonSerializerOptions);
            }
        }
    }
}
