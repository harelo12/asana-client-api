...
namespace AsanaApiClient.Model
{
    ...
    public partial class CreateProjectRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateProjectRequest(Option<ProjectRequest?> data = default)
        {
            DataOption = data;
            OnCreated();
        }
        ...
        public Option<ProjectRequest?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public ProjectRequest? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
    ...
    public class CreateProjectRequestJsonConverter : JsonConverter<CreateProjectRequest>
    {
        ...
        public override CreateProjectRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ProjectRequest?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<ProjectRequest?>(JsonSerializer.Deserialize<ProjectRequest>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CreateProjectRequest.");

            return new CreateProjectRequest(data);
        }
        ...
        {
            if (createProjectRequest.DataOption.IsSet && createProjectRequest.Data == null)
                throw new ArgumentNullException(nameof(createProjectRequest.Data), "Property is required for class CreateProjectRequest.");

            if (createProjectRequest.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, createProjectRequest.Data, jsonSerializerOptions);
            }
        }
    }
}
