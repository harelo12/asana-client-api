...
namespace AsanaApiClient.Client
{
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface IFailedDependency<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is FailedDependency
        /// </summary>
        /// <returns></returns>
        TType FailedDependency();

        /// <summary>
        /// Returns true if the response is FailedDependency and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryFailedDependency([NotNullWhen(true)]out TType? result);
    }
